...
const Footer = () => {
  return (
    <footer className="bg-white text-gray-600 border-t border-t-modern">
      <div className="py-12 md:px-16 px-8">
        <div className="flex justify-between flex-wrap gap-8">
          <div className="max-w-[450px]">
            ...
            <form className="flex mt-4 flex-col sm:flex-row sm:items-end">
              <button
                type="submit"
                className="py-2 px-6 max-w-[260px] border border-transparent text-sm font-medium rounded-full text-white bg-modern hover:bg-yellow-600 transition-colors duration-200"
              >
            ...
            <div className="flex space-x-3 mt-6">
              <a
                ...
                target="_blank"
              >
                <FaFacebookF className="text-modern hover:text-modern bg-black rounded-full p-[5px] text-2xl cursor-pointer" />
              </a>
              <a
                href="https://www.instagram.com/modernfurnishingdubai/"
                target="_blank"
              >
                <FaInstagram className="text-modern hover:text-modern bg-black rounded-full p-[5px] text-2xl cursor-pointer" />
              </a>
              <a
                href="https://www.linkedin.com/company/modernlook/?viewAsMember=true"
                target="_blank"
              >
                <FaLinkedinIn className="text-modern hover:text-modern bg-black rounded-full p-[5px] text-2xl cursor-pointer" />
              </a>
            </div>
            <a
          ...
          <div className="max-w-[230px]">
            ...
            <ul className="mt-4 text-sm space-y-2">
              <li>
                <FaPhone className="rotate-90 text-modern inline mr-2" />
                +971 55 8043423
              </li>
              <li>
                <TbDeviceLandlinePhone className="inline text-modern mr-2" />
                +971 04 3273027
              </li>
              <li>
                <FaEnvelope className="inline text-modern  mr-2" />
                <a href="mailto:test.com"> info@furnishingdubai.com</a>
              </li>
              <li>
                <FaWhatsapp className="inline text-lg mr-2 text-modern " />
                <a href="https://wa.me/971507114383">+971 507114383</a>
              </li>
              <li className="flex">
                <FaMapMarkerAlt className="block mr-2 text-modern  text-2xl" />
          ...
          <div>
            <h3 className="text-xl font-bask font-semibold tracking-wider uppercase text-black">
              Our
              <span className=" text-modern px-1 italic">Services!</span>
            </h3>
        ...
        <div className="md:col-span-3 mt-12 border-t border-gray-300 pt-8">
          <p className="text-center text-sm">
            &copy; 2023 Modern Furnishing Dubai. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
